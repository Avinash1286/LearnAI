...
export async function POST(req) {
    ...
    const enrollCourses=await db.select().from(enrollCourseTable).where(and(eq(enrollCourseTable.cid, courseId), eq(enrollCourseTable.userEmail, user.primaryEmailAddress?.emailAddress)));
